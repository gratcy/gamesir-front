! function(e) {
    ...
    var t = {
        ...
        owlCarousels: function() {
            ...
            }), e(".team-carousel").owlCarousel(e.extend(!0, {}, t, {
                loop: !1,
                margin: 30,
                responsive: {
                    0: {
        ...
        categoryListNav: function() {
            e(".category-list-nav").themeSticky({
                autoInit: !0,
                minWidth: 991,
        ...
        categoryNavScroll: function() {
            e(".category-list-nav").find("a").on("click", function(t) {
    ...
    jQuery(document).ready(function() {
        t.init()
        $('.select-custom > select[name="orderby"]').change(function(){
        	var val = $(this).val()
        	window.location.href = window.location.origin + window.location.pathname + '?order=' + val
        })
        
    	$('.select-custom > select > option[value='+params['order']+']', this).attr('selected','selected');
        
        if (detectmob()) {
            $('#cat-2 > .products-carousel > .owl-stage-outer > .owl-stage > .owl-item > .product > figure > iframe').attr('width', $('#cat-2 > .products-carousel > .owl-stage-outer > .owl-stage > .owl-item').width()
 + 'px')
            // $('#cat-2 > .products-carousel > .owl-stage-outer > .owl-stage > .owl-item').removeClass('active')
            // $('#cat-2 > .products-carousel > .owl-stage-outer > .owl-stage > .owl-item').css({'width': '100%'})
            // $('#cat-2 > .products-carousel > .owl-stage-outer > .owl-stage > .owl-item:eq(0)').addClass('active')
        }
